...
namespace Cibb.Web.BLL.Registration.Models
{
    public class UserModel
    {
        ...
        [System.Web.Mvc.Remote("CkUserName", "Registration", ErrorMessage = "{0}已被注册")]
        ...
        [Required(ErrorMessage = "真实姓名为必填项目")]
        ...
        [StringLength(100)]
        [Required(ErrorMessage = "公司名称为必填项目")]
        [Display(Name = "公司名称")]
